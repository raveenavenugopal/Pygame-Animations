...
while 1:
	...
	for i in range(4):
		...
		sangl=(sangl+120)%360
		x2=int(30 * math.cos(math.radians(sangl)))
		y2=int(30 * math.sin(math.radians(sangl)))
	
		sangl=(sangl+120)%360	
		x3=int(30 * math.cos(math.radians(sangl)))
		y3=int(30 * math.sin(math.radians(sangl)))
	
		pygame.draw.line(screen,grey,[xc+x+x2,yc+y+y2],[x+xc+x1,y+yc+y1],2)
		pygame.draw.line(screen,grey,[xc+x+x3,yc+y+y3],[x+xc+x1,y+yc+y1],2)
		pygame.draw.line(screen,grey,[xc+x+x3,yc+y+y3],[x+xc+x2,y+yc+y2],2)
	sangl=(sangl-3)%360
	small=(small+1)%360	
